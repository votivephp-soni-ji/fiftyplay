...
import { fetchEvents, pastEvents } from "../services/EventService";
...
const PastEvents = () => {
  ...
  const loadEvents = async (pageNo = 1) => {
    ...
    try {
      ...
      const res = await pastEvents({ page: pageNo, location, date, category });
      ...
      <div className="latest-events-add">
        <div className="container">
          <h1 className="text-center">
            Finalized <span className="events-text">Events</span>
          </h1>
